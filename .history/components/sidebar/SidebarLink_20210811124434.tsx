...
const SidebarLink = ({sidebarOpen,setSidebarOpen,type,url,text,icon,dropdownLinks}:SidebarLinkProps) => {
    ...
    const searchTerm = reduxHooks.useAppSelector((state:searchTermState) => {
    ...
    return (
        <>
            {
                type === types[0] ?
                    <li className={`${sidebarStyles.sidebarLink} ${!sidebarOpen ? sidebarStyles.sidebarLinkOpen : ""} ${sidebarStyles.sidebarSearch} ${!sidebarOpen ? sidebarStyles.sidebarSearchActive : ""}`}>
