...
const SidebarLink = ({sidebarOpen,setSidebarOpen,type,url,text,icon}:SidebarLinkProps) => {
                ...
                props.type === types[0] ?
                    <li className={`${sidebarStyles.sidebarLink} ${props.sidebarOpen ? sidebarStyles.sidebarLinkOpen : ""} ${sidebarStyles.sidebarSearch} ${props.sidebarOpen ? sidebarStyles.sidebarSearchActive : ""}`} onClick={() => {
                        ...
                        <div className={` ${sidebarStyles.searchContainer}`} >
                            ...
                            <input type="search" name="searchBar" value={searchTerm || ""} className={`${sidebarStyles.searchBar} ${!props.sidebarOpen ? sidebarStyles.searchBarClosed : ""}`}
                                onChange={(e) => {
