...
const Sidebar = (props) => {
    ...
    return (
        <div className={`${sidebarStyles.sidebar} ${props.sidebarOpen ? sidebarStyles.sidebarOpen : sidebarStyles.sidebarClose}`}>
            ...
            <div className={sidebarStyles.sidebarMenu}>
                <ul className={`${sidebarStyles.sidebarList}`}>
                    ...
                    <SidebarLink type="singleLink" text="Movies" icon={<MovieIcon/>} sidebarOpen={props.sidebarOpen} setSidebarOpen={props.setSidebarOpen}/>

                    <SidebarLink type="singleLink" text="TV Shows" icon={<TvIcon/>} sidebarOpen={props.sidebarOpen}  setSidebarOpen={props.setSidebarOpen}/>
