        ...
        <div className={`${sidebarStyles.sidebar} ${props.sidebarOpen ? sidebarStyles.sidebarActive : ""}`}>
            ...
            <div className={sidebarStyles.sidebarMenu}>
                <ul className={`${sidebarStyles.sidebarList}`}>
                    ...
                    <SidebarLink type="dropdown" text="Movies" icon={<MovieIcon/>} sidebarOpen={props.sidebarOpen} setSidebarOpen={props.setSidebarOpen}/>

                    <SidebarLink type="dropdown" text="TV Shows" icon={<TvIcon/>} sidebarOpen={props.sidebarOpen}  setSidebarOpen={props.setSidebarOpen}/>
