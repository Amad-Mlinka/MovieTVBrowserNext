...
const MediaList = ({ media }) => {
    console.log($(`.${mediaListStyles.arrowLeft}`))
    console.log($(`.${mediaListStyles.arrowRight}`))
    ...
    var settings = {
        ...
        slidesToScroll: 1,
        variableWidth: false,
        /*prevArrow: $(`.${mediaListStyles.arrow} ${mediaListStyles.arrowLeft}`),
        nextArrow: $(`.${mediaListStyles.arrow} ${mediaListStyles.arrowRight}`),*/
        responsive: [
            {
                breakpoint: 1024,
                settings: {
