                ...
                <div className={mediaListStyles.content}>
                    ...
                    <Slider {...settings} ref={sliderRef}>
                        {props.media.map((media) => (
                            <Media key={props.media.id} className={mediaListStyles.mediaItem} id={props.media.id} image={props.media.poster_path} rating={props.media.vote_average / 5} title={props.media.title} year={props.media.release_date} />
                        ))}
