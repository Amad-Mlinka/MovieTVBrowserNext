...
const MediaList = (props) => {
    useEffect(() => {        
            console.log("https://api.themoviedb.org/3/discover/movie?api_key="+process.env.apiKey+"&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate")     
    ...
    return (
        <>
            <div className={homeStyles.mediaList}>
                <Slider {...settings}>
                    <Media className={homeStyles.mediaItem} rating={3} title={props.movies.results[0].title} year={"1982"} />
