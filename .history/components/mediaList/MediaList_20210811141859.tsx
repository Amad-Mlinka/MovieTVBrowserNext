            ...
            <div className={mediaListStyles.mediaList} >
                <div className={mediaListStyles.content}>
                    ...
                    </div>
                    {
                        ...
                        {media.map((media) => (
                            <Media key={media.id} className={mediaListStyles.mediaItem} id={media.id} image={media.poster_path} rating={Math.round((media.vote_average / 2) * 10) / 10} title={mediaType == "movie" ? media.title : media.name} year={mediaType === "movie" ? media.release_date : media.first_air_date} />
                        ))}
