                ...
                <div className={mediaListStyles.content}>
                    ...
                    <Slider {...settings} ref={sliderRef}>
                        {props.media.map((media) => (
                            <Media mediaType={props.mediaType} key={media.id} className={mediaListStyles.mediaItem} id={media.id} image={media.poster_path} rating={media.vote_average / 5} title={media.title} year={media.release_date} />
                        ))}
