                ...
                <div className={mediaListStyles.content}>
                    ...
                    <Slider {...settings} ref={sliderRef}>
                        {props.media.map((media) => (
                            <Media key={media.id} className={mediaListStyles.mediaItem} id={media.id} image={media.poster_path} rating={Math.round((media.vote_average / 5)*10)/10} title={props.mediaType === "movie" ? media.title : media.name} year={props.mediaType === "movie" ? media.release_date : media.first_air_date} />
                        ))}
