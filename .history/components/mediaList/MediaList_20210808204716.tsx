            ...
            <div className={mediaListStyles.mediaList} >
                <div className={mediaListStyles.arrows}>
                    <div className={mediaListStyles.arrowsContainer}>
                        <div className={`${mediaListStyles.arrow} ${mediaListStyles.arrowLeft}`} onClick={()=>Slider.slickPrev()}><ChevronLeftIcon /></div>
                        <div className={`${mediaListStyles.arrow} ${mediaListStyles.arrowRight}`}  onClick={()=>Slider.slickNext()}><ChevronRightIcon /></div>
                    </div>
                </div>
                <Slider {...settings}>
                    {media.map((media) => (
