...
const Navbar = () => {
    ...
    const sidebar = reduxHooks.useAppSelector((state: RootState) =>{
        console.log(state.sidebarReducer.open)
        state.sidebarReducer.open
    } )
            ...
            <div className={navStyles.left}>
                <div className={navStyles.hamburgerLogo}>
                    <div className={navStyles.hamburger} onClick={() => {
                        ...
                        <div className={`${navStyles.spinner} ${navStyles.diagonal} ${sidebar==true ? navStyles.part1Active : ""}`}></div>
