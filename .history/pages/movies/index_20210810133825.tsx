    ...
    return (
        <>
           ...
           {/* <MediaList mediaType="movie" media={discoverMovies.results} heading="Discover Movies" subHeading="Discover new Movies picked just for you" />
            <MediaList mediaType="movie" media={latesMovies.results} heading="Latest Movies" subHeading="Learn more about the latest movies" />*/}
        </>
    )
}
...
export const getStaticProps = async () => {
    ...
    const res3 = await fetch(`https://api.themoviedb.org/3/movie/latest?api_key=${process.env.apiKey}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate`);
