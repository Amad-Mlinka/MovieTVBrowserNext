  ...
  return (
    <>
      ...
      <div className={homeStyles.buffer}></div>
       <MediaList media={props.movies.results} heading="Movies" subHeading="Movies picked just for you" />
       <MediaList media={props.tv.results} heading="TV" subHeading="TV shows picked just for you" />
    </>
